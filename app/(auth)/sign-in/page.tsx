    ...
    <div className="relative min-h-screen bg-[#080b12] text-[#f0eeff] overflow-x-hidden font-['Soria',-apple-system,BlinkMacSystemFont,'Segoe_UI',Roboto,Helvetica,Arial,sans-serif]">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row min-h-screen overflow-x-hidden overflow-y-hidden">
        ...
        <motion.div
          ...
          className="flex-1 flex items-center justify-center px-6 sm:px-10 lg:px-14 py-12 lg:py-16"
        >
          <div className="max-w-2xl w-full">
            ...
            >
              ...
              <span className="text-base text-white/45">
                Trusted by <strong className="text-white font-semibold">12,400+</strong> professionals worldwide
              </span>
            </motion.div>
            ...
            <div className="flex gap-8 sm:gap-12 pt-8 border-t border-white/10">
              {[
                { value: "48k+", label: "Resumes Created" },
        ...
        <motion.div
          ...
          className="w-full lg:w-[500px] flex items-center justify-center px-6 sm:px-8 py-12 lg:py-16"
        >
...
>
  ...
  whileTap={{ scale: 0.98 }}
  className="flex items-center w-full justify-center gap-2 py-2.5 sm:py-3 rounded-lg border border-white/10 bg-white/5 text-white/45 text-xs sm:text-sm font-medium transition-all"
>
            ...
            <form onSubmit={handleSignIn} className="space-y-4">
              ...
              <div className="flex justify-between items-center mt-5 mb-6">
                ...
                >
                  <input
                    type="checkbox"
                    className="w-3.5 h-3.5 sm:w-4 sm:h-4 rounded border border-white/15 bg-white/5 accent-[#c4b0ff] cursor-pointer"
                  />
                  <span className="text-xs sm:text-sm text-white/45 group-hover:text-white/70 transition-colors">
                    Remember me
                  </span>
                </motion.label>
                <motion.a
                  ...
                  className="text-xs sm:text-sm text-[#c4b0ff] font-medium hover:text-[#7ee8fa] transition-colors"
                >
                  Forgot password?
                </motion.a>
              </div>
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full py-3 sm:py-3.5 rounded-lg font-bold text-sm sm:text-base text-[#0a0714] bg-gradient-to-r from-[#c4b0ff] via-[#7ee8fa] to-[#ff9de2] shadow-[0_4px_28px_rgba(196,176,255,0.30)] hover:shadow-[0_8px_36px_rgba(196,176,255,0.45)] transition-all duration-200 relative overflow-hidden group"
              >
                <motion.span
