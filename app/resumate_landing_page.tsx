      ...
      <div className="container">
        <div className="nav-inner">
          ...
          <div className="nav-cta">
            <a href="login-page.html" className="btn btn-ghost">Login</a>
            <a href="signup-page.html" className="btn btn-primary">Sign Up</a>
          </div>
          <button
            className="hamburger"
...
export default function ResumateLandingPage() {
  useScrollReveal();
